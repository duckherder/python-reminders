...
print("\ncomprehensions allow sequences to be built from other sequences...")
print(
...
print("\nnested list comprehension can generate an identity matrix - lists within lists...")
...
print("\nyou can have if-else statements in the output expression...")
print("['odd' if x % 2 else 'even' for x in my_list] =",
      ['odd' if x % 2 else 'even' for x in my_list])
print("useful for situations where you want to keep output sequence the same size as the input sequence")
...
my_tuple = (1, 2, 3)
print("\nthe input sequence can be any sequence, such as a tuple or zip output such as", my_tuple, "...")
