...
print("my_list_copy = copy.copy(my_list) -> creates a new list - same as my_list.copy() list method")
...
print("but what about compound objects - 'objects that contain other objects, like lists or class instances'")
...
print("my_compound_list_copy = copy.deepcopy(my_compound_list) performs a **deep** copy")
print("....so the lists have different addresses")
print("my_compound_list is at", id(my_compound_list))
print("my_compound_list_copy is at", id(my_compound_list_copy))
...
print("so care needs to be taken when using repetition to create compound objects")
