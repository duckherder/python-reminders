...
print("############# PULL PIPELINES ##############")
print("generators can be used for iteration based data pipelines...")
...
print("create a data pipeline using generators...")
...
print("same can be done using generator comprehensions...")
...
print("you can create many-to-one generators in the pipeline with zip...")
...
print("############# PUSH PIPELINES ##############")
# see http://www.dabeaz.com/coroutines/
print("coroutines can be used to create producer-consumer data pipelines...")
...
print("create a data pipeline using coroutines...")
...
print("create a data pipeline with broadcasting coroutines...")
