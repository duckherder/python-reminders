...
print("use map to apply a function to an iterable...")
...
print("very similar to using a list comprehension...")
print("result = [(lambda x : x * 2)(y) for y in [1, 2, 3]]")
result = [(lambda x: x * 2)(y) for y in [1, 2, 3]]
print(type(result))
print(result)

print("but in fact more like a generator...")
result = ((lambda x: x * 2)(y) for y in [1, 2, 3])
print(type(result))
for i in result:
    print(i)
...
print("you can pass a lambda or a any function...")
...
print("what about multiple arguments to my_func...")
...
print("use filter() to filter out items in an iterable - function or lambda must return True or False...")
...
print("to use a function with multiple parameters use a lambda or a closure...")
...
print("use reduce to reduce am iterable to a single object based on a reduction function and sliding window")
